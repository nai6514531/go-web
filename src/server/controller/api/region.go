 ...
 *     }
 */
func (self *RegionController)DistrictsOfCity(ctx *iris.Context) {
	regionService := &service.RegionService{}
 ...
 *     }
 */
func (self *RegionController)CitiesOfProvince(ctx *iris.Context) {
	regionService := &service.RegionService{}
	id, _ := strconv.Atoi(ctx.Param("id"))
	result := &enity.Result{}
